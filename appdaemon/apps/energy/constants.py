...
JSON_AVG_PRICE_FILE="/config/apps/energy/avg_day_price.json"
TOP_THREE_KWH_HOURS_FILE="/config/apps/energy/storage/topthreehours.txt"
TOP_THREE_KWH_HOURS_RESET_FILE="/config/apps/energy/storage/topthreehours_reset.txt"
